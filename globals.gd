...
enum spell_type {NONE, PROJECTILE, AURA, STRUCTURE, BLAST, CQB, MOVEMENT}
enum spell_mod {NONE, 
	#old general mods
	COLOR_RED, COLOR_YELLOW, COLOR_BLUE, COLOR_GREEN, 
	EXTRA_CHARGE, EXTRA_DMG, EXTRA_AOE, CAST_SPREAD, REFLECT, 
	DURATION_UP, DURATION_DOWN, PUSH, PULL,
	##Projectile mods
	#PROJ_PIERCE, PROJ_BOUNCE, PROJ_STICKY, 
	#PROJ_STRAIGHT, PROJ_PARABOLIC, PROJ_MANUAL,
	#PROJ_TIMER, PROJ_CONTACT, PROJ_REMOTE,
	#PROJ_DAMAGE, PROJ_KNOCKUP,
	##CQB mods
	#CQB_SWORD, CQB_CONE, CQB_SHIELD,
	#CQB_KNOCKBACK, CQB_DAMAGE,
	##aura mods
	#AURA_MINE, AURA_QUICK,
	#AURA_DRAIN, AURA_SLOW, AURA_DAMAGE, AURA_WEAKEN,
	#AURA_LINGER, AURA_BURSTS,
	##movement mods
	#MOVE_SPRINT, MOVE_FLIGHT, MOVE_BLINK
	}
