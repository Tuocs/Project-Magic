...
enum spell_mod {NONE, COLOR_RED, COLOR_YELLOW, COLOR_BLUE, COLOR_GREEN, EXTRA_CHARGE, EXTRA_DMG, EXTRA_AOE, CAST_SPREAD, REFLECT, TRAP, PUDDLE, DURATION_UP, DURATION_DOWN, PUSH, PULL}
